...
export default function CentralAdminPanel({ section }) {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      const result = await request(path); setData(result); if (section === 'credits' && result.users) setCreditUsers(result.users);
