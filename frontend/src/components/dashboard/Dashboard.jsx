    ...
    <div className="dashboard">
      <div className={`sidebar ${mobileView === 'chat' ? 'sidebar-hidden-mobile' : ''}`}>
          ...
          <div className="sidebar-header-top">
            ...
            <div className="sidebar-actions">
              {!waStatus.isConnected && (
                <div className="wa-status-badge disconnected" title="WhatsApp non connecté">●</div>
              )}
              {waStatus.isConnected && (
                <div className="wa-status-badge connected" title="WhatsApp connecté">●</div>
              )}
        ...
        <div className="sidebar-content">
          ...
          {activePanel === 'config' && (
            <BotConfig waStatus={waStatus} onConnectWhatsApp={() => socket?.emit('connect-whatsapp')} onLogoutWhatsApp={() => {}} />
          )}
        </div>
      </div>
