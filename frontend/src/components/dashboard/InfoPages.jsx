...
export function HowItWorksPage({ onBack }) {
  ...
  >
    ...
    <div className="info-tip"><strong>Délai de regroupement des messages</strong><span>Botora attend par défaut 15 secondes après le dernier message reçu avant de générer une réponse. Ce délai permet de regrouper plusieurs messages envoyés à la suite et d’éviter des réponses fragmentées. Vous pouvez l’ajuster dans Réglages Bot, de 1 seconde à 5 minutes.</span></div>
    <div className="info-tip"><strong>Réponses continues</strong><span>Les réponses IA suivent leur cours dès que WhatsApp est connecté et que les fonctions concernées sont activées. Il n’y a plus d’horaires de bureau à configurer : Botora peut donc traiter les messages à tout moment, y compris la nuit.</span></div>
